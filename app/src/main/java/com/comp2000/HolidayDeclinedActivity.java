...
/**
 * Demonstrates a screen where a holiday request is declined,
 */
public class HolidayDeclinedActivity extends Activity {
    ...
    // Main content
    private TextView declinedMessage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String layoutName = "holidaydeclined";
    ...
    private void bindContentSection() {
        declinedMessage = findViewById(getViewIdByName("declined_message"));
